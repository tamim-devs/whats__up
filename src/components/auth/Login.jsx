          ...
          <div className='flex justify-center items-center h-screen'>
              <div className='pt-40 pb-20 bg-white px-40 rounded-[41px]'>
                  <div className='flex flex-col  gap-4' >
                    ...
                    <h1 className='text-4xl flex justify-center text-black'>Login Page</h1>
                     ...
                     <div className='flex flex-col gap-4'>
                      ...
                      <button type='submit' className='w-[312px] rounded-2xl text-2xl font-bold text-white bg-sky h-[62px] '>Log in</button>
                      </div>
                     </form>
                  </div>
              </div>
